...
// 106 — تراس فيو: ٨ شقق + ملحقان = ١٠ وحدات (الحالات من جدول الحجوزات الرسمي)
...
['01', '02', '03', '04', '05', '06', '07', '08'].forEach((n, i) => {
  U106.push({ code: n, model: 'ش', type: 'شقة', facing: '', floor: _fl106[i], area: 0, rooms: 0, baths: 0, price: 1200000, status: _st106[i] });
});
['09', '10'].forEach((n, i) => {
  U106.push({ code: n, model: 'م', type: 'ملحق', facing: '', floor: 'علوي', area: 0, rooms: 0, baths: 0, price: 1200000, status: _st106[8 + i] });
});
...
const PROJECTS = [
  ...
  },
  {
    ...
    status: 'بدأ البيع', completion: 100, floors: 4, annexes: 2, priceFrom: 1200000, boardOnly: true,
    desc: 'المراد تراس فيو في حي السلامة بجدة؛ ثماني شقق عصرية بإطلالات مفتوحة وتراسات خاصة، مع ملحقين علويين. تابع جدول توفّر الوحدات أدناه، وتفاصيل النماذج تُعلن قريباً.',
    features: ['ثماني شقق + ملحقان', 'تراسات وإطلالات مفتوحة', 'تصاميم عصرية', 'مواقف خاصة', 'دخول ذكي', 'قرب من جميع الخدمات'],
    images: [],
    units: U106,
  },
  {

...
const PROPERTIES = [
  ...
  },
  {
    ...
    rooms: 0,
    baths: 4,
    desc: 'معرض تجاري على طريق رئيسي في حي الزهراء بجدة، واجهة زجاجية بطول 40 متراً ومواقف أمامية واسعة، عائد استثماري مجزٍ.',
  ...
  },
  {
    ...
    rooms: 4,
    baths: 5,
    desc: 'شقة دورين (دوبلكس) بسطح خاص في حي النعيم بجدة، تشطيبات بمواصفات الفلل ضمن مشروع سكني متكامل الخدمات.',
    features: ['سطح خاص', 'إطلالة مفتوحة', 'مدخلان', 'نظام صوتي مدمج', 'أمن على مدار الساعة', 'نادٍ رياضي مشترك'],
    images: [
